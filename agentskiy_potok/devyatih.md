# Трудозатраты в рекламном агентстве - как считать и как снижать?
...
1. Какие работы провел исполнитель для повышения эффективности размещения?

1. Как повлияли изменения в условиях и работы исполнителя на динамику KPI?
...
* Количество изменений объявлений, включая:
  ...
  * Добавление картинок
  * Изменение временноготаргетинга
